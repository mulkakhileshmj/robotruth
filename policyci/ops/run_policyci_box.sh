...
# script only syncs the tree, starts box_first_light.sh THERE, and pulls the results back.
#
...
$SSH "bash ~/$REMOTE_DIR/robotruth/policyci/ops/box_first_light.sh ~/$REMOTE_DIR '$N' '$SHARDS' '$BIASES'"
